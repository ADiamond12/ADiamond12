...
- Applied AI systems with deterministic fallback behavior.
- Workflow automation with human review rather than blind model output.
- Data/reporting pipelines with fixture-backed demos and repeatable artifacts.
- Linux, SQL, testing, and software commissioning discipline from warehouse automation work.

## Notes

- Public repositories are kept intentionally scoped and runnable without private data.
- Private or sensitive research projects are represented only through public-safe case studies on the portfolio site.
- I do not publish API keys, local paths, private datasets, model weights, or workplace material.
